...
def upgrade() -> None:
    ...
    with op.batch_alter_table("equipment_types") as batch_op:
        batch_op.create_unique_constraint("uq_equipment_types_type_name", ["type_name"])  # Уникальное ограничение


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    
    # Используем batch mode для удаления ограничения в SQLite
