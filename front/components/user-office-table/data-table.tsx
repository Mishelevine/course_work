...
interface UserOfficeDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[]
  data: TData[]
}

export function UserOfficeDataTable<TData, TValue>({
  columns,
  data,
}: UserOfficeDataTableProps<TData, TValue>) {
